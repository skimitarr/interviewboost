...
export default function MyQuestions() {
  ...
  const submitForm = async (e: FormEvent<HTMLFormElement>) => { // отправляем данные в гугл таблицу (и не только)
    ...
    В своем анализе ты опираешься строго на фактические оценки и комментарии. Ты не использую предположительные слова "возможно", "вероятно", “скорее всего”, “наверное”.
