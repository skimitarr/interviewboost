...
import { IProffesion, IGrade, ICategory, IQuestion, IAnswer, DataReport } from '../app/components/Types'
...
const addReport = (name: string, data: any) => { // добавляем подколлекцию
    setDoc(doc(db, "reports", name), data);
};
...
export { getDbProfessions, getDbAllGrades, getDbAllCategories, getDbAllQuestions, getDbAnswers, getDbAllAnswers, addReport }
